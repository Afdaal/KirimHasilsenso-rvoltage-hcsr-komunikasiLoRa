...
#define voltageSensorPin A5  // Assuming you connect the voltage sensor to A0
...
void loop() {
  ...
  voltageValue = (sensorValue / 1024.0) * 25.0;  // Assuming 5V reference voltage
  ...
  delay(3000);  // Delay for 2 seconds before sending the next packet
}
